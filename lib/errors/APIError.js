 ...
 * @property {Object} APIError.fault - Fault-Object containing the error code and message possibly returned by the
...
function APIError(message, response, code) {
    ...
    if (response && response.fault) {
        ...
        // the message for this Error object.  Otherwise, we'll take the HTTP response
