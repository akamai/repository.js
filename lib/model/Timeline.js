...
function Timeline(serviceUrl, sourceType) {

	var Tokens = require("./Tokens.js");
	var TimelineObject = require("./TimelineObject.js");

	// Fallback to production Service URL
	serviceUrl = serviceUrl || constants.TIMELINE_URL;

	var tokens = new Tokens(serviceUrl + "/mpulse/api/timeline/v1", sourceType);
	var timeline = new TimelineObject(serviceUrl, sourceType);
	...
	/**
	 * Wraps Timeline API wrapper instance into a promise based API instance. You may afterwards use all the
	...
	this.asPromises = function() {
		var promisesRepository = new Timeline(serviceUrl, sourceType);
