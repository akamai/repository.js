...
function Objects(serviceUrl) {
    ...
    serviceUrl.indexOf("/services/rest/RepositoryService/v1") != -1 ? this.endpoint = serviceUrl + "/Objects" : 
          this.endpoint = serviceUrl + "/services/rest/RepositoryService/v1/Objects";
