 ...
 * @param {Tokens~connect(callback)} callback - A callback called after either a successful or unsuccessful execution of the authentication
 */
 ...
 *
 * @param {?Error} err - {@link null} or an Error object describing the type of Exception that occured during de-authentication
