...
function Annotation(serviceUrl) {
    ...
    var tokens = new Tokens(serviceUrl + "/mpulse/api/annotations/v1");
    var annotation = new AnnotationObject(serviceUrl);
    ...
    /**
     * See [deleteAnnotationObject in Objects]{@link Annotation#deleteTimelineObject}. 
     * The {@link token} will be passed on directly
     *
