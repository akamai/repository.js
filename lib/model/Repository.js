...
function Repository(serviceUrl) {

    var Tokens = require("./Tokens.js");
    var Objects = require("./Objects.js");
    var SeedData = require("./SeedData.js");

    var tokens = new Tokens(serviceUrl + "/services/rest/RepositoryService/v1");
    ...
    /**
     * See [getToken in Tokens]{@link Tokens#getToken}. A token object will be returned that is associated with the given {@link apiToken}
     * 
     * @param {?string} tenantName 
     * @param {string} apiToken 
     * @param {function} callback 
     */
    this.getToken = function(tenantName, apiToken, callback) {
        tokens.getToken(tenantName, apiToken, callback);
    }
